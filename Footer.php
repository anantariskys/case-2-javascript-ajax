...
<footer
  class="flex flex-col items-center bg-[#D6DAF7] text-center text-surface dark:bg-neutral-700 dark:text-white">
  ...
  <div class="w-full bg-[#007b8E] p-4 text-center">
    © 2024 Copyright:
    <a href="https://tw-elements.com/">Kelompok 3</a>
  </div>
</footer>